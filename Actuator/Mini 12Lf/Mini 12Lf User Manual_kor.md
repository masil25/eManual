...
>- 본 매뉴얼은 기존의 Position control 기능만 지원되는 L12시리즈 뿐만이 아니라, 전류 및 속도 control이  가능한 mightyZAP 12Lf 시리즈  액츄에이터 전용 매뉴얼입니다.     
>- 모델명이 12Lf로 시작하는 제품 사용자중<u> IR오픈 프로토콜 사용자분들만</u> 본 매뉴얼을 참고하시기 바랍니다.     
>- 12Lf시리즈 사용자 중 MODBUS RTU 프로토콜 사용자는 별도의 12Lf 시리즈 MODBUS RTU매뉴얼을, 모델명이 D 혹은 L로 시작하는 제품 사용자는 별도의 L12/D12/D7 시리즈 Position control매뉴얼을 참고하시기 바랍니다.     
...
## 1.4. 지속적 부하 / 과부하 보호
><font size="5"><center><b>중요 : 과부하 조건 / 과부하<br>
(Overload) 보호 기능 / Force Off 기능</b></center></font>
