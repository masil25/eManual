...
| Parameter | Min | Norm | Max | Unit | Note |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Maximum peak Current <br>/ 최대 피크 전류** |  |  |  | A | Stall Current |
| **No Load Current <br>/ 무 부하 전류** |  |  |  | mA | No Load |
| **Rated Load Current <br>/부하 시 전류** |  |  |  | mA | at over Goal current800mA setting / 골커런트 800mA 이상설정 |
| **Max Applicable Load Current / <br>최대 허용 부하 시 전류** |  |  |  |  | at Goal current 1.6Asetting   <br>/ 골커런트1.6A설정 시 |
| **Idle Current** |  |  |  | mA |  |
