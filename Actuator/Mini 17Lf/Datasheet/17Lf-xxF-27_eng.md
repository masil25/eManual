...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Stroke / 스트로크**                         | 27mm                                                                                                                                                                                                                                                     |
| **Rated Load / 정격 부하**                    | 기어비에 따라 20N-70N                                                                                                                                                                                                                                          |
...
| **Extended Wire Harness**                 | Molex(51021-0500), 5pins / 200mm length, 0.16 x 7 (26AWG)                                                                                                                                                                                                |
...
정격 부하 속도의 경우 무 부하 최대 속도 대비 모델에 따라 약 80 ~ 90% 대의 성능을 보여줍니다. 
>[!tip] TIP
